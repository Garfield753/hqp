...
MESCH_API VEC *v_set(VEC *, HQPReal);
...
MESCH_API HQPReal sp_norm_inf(SPMAT *);
MESCH_API SPMAT *sp_copy3(const SPMAT *, SPMAT *);
MESCH_API int sp_update_val(SPMAT *, int, int, HQPReal);
...
MESCH_API HQPReal sprow_inprod(const SPROW *r1, const VEC *inner, const SPROW *r2);
 ...
 */
//@{
MESCH_API void sp_into_sp(const SPMAT *src, HQPReal s, SPMAT *dst,
			  const PERM *px, int i_offs, int j_offs);
MESCH_API void spT_into_sp(const SPMAT *src, HQPReal s, SPMAT *dst,
			   const PERM *px, int i_offs, int j_offs);
MESCH_API void sp_into_symsp(const SPMAT *src, HQPReal s, SPMAT *dst,
			     const PERM *px, int i_offs, int j_offs);
MESCH_API void symsp_into_symsp(const SPMAT *src, HQPReal s, SPMAT *dst,
				const PERM *px, int offs);
MESCH_API void spT_into_symsp(const SPMAT *src, HQPReal s, SPMAT *dst,
			      const PERM *px, int i_offs, int j_offs);

MESCH_API void sp_into_bd(const SPMAT *sp, HQPReal s, BAND *bd,
			  const PERM *px, int i_offs, int j_offs);
MESCH_API void spT_into_bd(const SPMAT *sp, HQPReal s, BAND *bd,
			   const PERM *px, int i_offs, int j_offs);
//@}
