...
typedef	struct  {
		...
		HQPReal	**me,*base;	/* base is base of alloc'd mem */
		} MAT;
...
MESCH_API VEC	*sv_mlt MESCH__P((HQPReal, const VEC *, VEC *));
...
MESCH_API VEC	*v_mltadd MESCH__P((const VEC *, const VEC *, HQPReal, VEC *));

#ifdef HAVE_PROTOTYPES_IN_STRUCT
MESCH_API VEC	*v_map MESCH__P((HQPReal (*f) MESCH__P((HQPReal)), 
				 const VEC *, VEC *));
MESCH_API VEC	*_v_map MESCH__P((HQPReal (*f) MESCH__P((void *, HQPReal)), 
				  void *, const VEC *, VEC *));
#else
MESCH_API VEC	*v_map MESCH__P((HQPReal (*f)(), const VEC *, VEC *));
MESCH_API VEC	*_v_map MESCH__P((HQPReal (*f)(), void *, const VEC *, VEC *));
#endif

MESCH_API VEC	*v_lincomb MESCH__P((int, const VEC *[], const HQPReal *, VEC *));
MESCH_API VEC	*v_linlist MESCH__P((VEC *out, const VEC *v1, HQPReal a1, ...));

MESCH_API HQPReal	v_min MESCH__P((const VEC *, int *));
MESCH_API HQPReal	v_max MESCH__P((const VEC *, int *));
MESCH_API HQPReal	v_sum MESCH__P((const VEC *));
...
MESCH_API HQPReal	_in_prod MESCH__P((const VEC *x, const VEC *y, 
					   u_int i0));

/* returns sum_{i=0}^{len-1} x[i].y[i] */
MESCH_API HQPReal	__ip__ MESCH__P((const HQPReal *, const HQPReal *, int));

/* see v_mltadd(), v_add(), v_sub() and v_zero() */
MESCH_API void	__mltadd__ MESCH__P((const HQPReal *, HQPReal *, HQPReal, int));
MESCH_API void	__add__ MESCH__P((const HQPReal *, const HQPReal *, HQPReal *, int));
MESCH_API void	__sub__ MESCH__P((const HQPReal *, const HQPReal *, HQPReal *, int));
MESCH_API void	__smlt__ MESCH__P((const HQPReal *, HQPReal, HQPReal *, int));
MESCH_API void	__zero__ MESCH__P((HQPReal *,int));
...
MESCH_API HQPReal	_v_norm1 MESCH__P((const VEC *x, const VEC *scale));
MESCH_API HQPReal	_v_norm2 MESCH__P((const VEC *x, const VEC *scale));
MESCH_API HQPReal	_v_norm_inf MESCH__P((const VEC *x, const VEC *scale));

/* unscaled matrix norms */
MESCH_API HQPReal	m_norm1 MESCH__P((const MAT *A));
MESCH_API HQPReal	m_norm_inf MESCH__P((const MAT *A));
MESCH_API HQPReal	m_norm_frob MESCH__P((const MAT *A));
...
MESCH_API MAT	*sm_mlt MESCH__P((HQPReal s, const MAT *A, MAT *out));
...
MESCH_API MAT	*ms_mltadd MESCH__P((const MAT *A, const MAT *B, HQPReal s, 
				     MAT *out));
...
MESCH_API HQPReal	square MESCH__P((HQPReal x));
/*MESCH_API HQPReal	cube MESCH__P((HQPReal x)); */
MESCH_API HQPReal	mrand MESCH__P((void));
MESCH_API void	smrand MESCH__P((int seed));
MESCH_API void	mrandlist MESCH__P((HQPReal *x, int len));
